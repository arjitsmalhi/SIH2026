// EduRise Localization Engine (English & Hindi)
const i18n = {
  currentLang: localStorage.getItem('edurise_lang') || localStorage.getItem('edusync_lang') || 'en',
  ...
  translations: {
    en: {
      ...
      searchingNearby: 'Scanning for nearby EduRise devices...',
      connect: 'Connect',
      ...
      aboutTitle: 'About EduRise',
      aboutDesc: 'EduRise is an offline-first educational platform designed for rural schools. It enables teachers and students to share lessons, complete quizzes, and sync student scores peer-to-peer using Bluetooth without needing any internet connection.',
    ...
    hi: {
      ...
      searchingNearby: 'आस-पास के एडुराइज़ डिवाइस खोजे जा रहे हैं...',
      connect: 'कनेक्ट करें',
      ...
      navigation: 'नेविगेशन',
      aboutTitle: 'एडुराइज़ के बारे में',
      aboutDesc: 'एडुराइज़ ग्रामीण विद्यालयों के लिए डिज़ाइन किया गया एक ऑफ़लाइन शिक्षा मंच है। यह शिक्षकों और विद्यार्थियों को बिना इंटरनेट ब्लूटूथ के माध्यम से पाठ साझा करने, क्विज़ हल करने और अंक सिंक करने की सुविधा देता है।',
  ...
  setLanguage(lang) {
    if (this.translations[lang]) {
      ...
      localStorage.setItem('edurise_lang', lang);
